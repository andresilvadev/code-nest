...
export class UserRepository extends Repository<User> {
    ...
    async createUser(createUserDto: CreateUserDto, role: UserRole): Promise<User> {
        ...
        try {
            ...
            // O código de erro 23505, que segundo a documentação do PostgreSQL é o código de erro retornado quando há conflito de um campo marcado como único — unique_violation
